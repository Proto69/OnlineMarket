<x-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600 dark:text-gray-400">
            {{ __('Ако е необходимо, можете да излезете от всичките си други сесии на браузъра на всичките си устройства. Някои от последните Ви сесии са изброени по-долу; този списък обаче може да не е изчерпателен. Ако смятате, че акаунтът Ви е бил компрометиран, трябва да актуализирате паролата си.') }}
        </div>
