    ...
    <div class="container mx-auto px-4 py-8">
        <div class="shadow-md rounded-lg p-6">
            <div class="flex items-center justify-center mb-6">
                ...
                <h1 class="text-3xl font-bold text-center text-gray-900 dark:text-gray-500 mx-4">Благодарим за
                    покупката!</h1>
            ...
            <div class="text-center text-xl text-gray-700 dark:text-gray-800 mb-6">
                Плащането е <strong>успешно</strong>! Вашата поръчка се обработва!
            </div>
