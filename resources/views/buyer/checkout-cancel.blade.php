    ...
    <div class="container mx-auto px-4 py-8">
        <div class="shadow-md rounded-lg p-6">
            <div class="flex items-center justify-center mb-6">
                ...
                <h1 class="text-4xl font-bold text-center text-gray-800 dark:text-gray-900 mx-4">Покупката не е завършена!</h1>
            ...
            <div class="text-center text-3xl text-gray-700 dark:text-gray-800 mb-6">
                Плащането е <strong class="text-red-600">неуспешно</strong>!
