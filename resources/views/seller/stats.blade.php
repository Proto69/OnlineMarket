                ...
                <form action="{{ route('test', 54) }}" method="GET">
                    ...
                    <div class="max-w-sm w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
                        <div class="flex justify-between">
                            <div>
                                <h5 class="leading-none text-3xl font-bold text-gray-900 dark:text-white pb-2">{{ $totalIncome }}лв</h5>
                                <p class="text-base font-normal text-gray-500 dark:text-gray-400">Приходи тази седмица</p>
                            </div>
                        </div>
